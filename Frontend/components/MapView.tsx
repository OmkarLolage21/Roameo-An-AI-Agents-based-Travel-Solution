    ...
    <Card className="h-[calc(100vh-220px)] overflow-hidden">
      ...
      >
        ...
        {suggestedPlaces?.map((place, index) => {
          // Handle both coordinate formats: object with longitude/latitude properties or array
          const longitude = place.coordinates ? 
            (Array.isArray(place.coordinates) ? place.coordinates[0] : place.longitude) : 
            place.longitude;
          const latitude = place.coordinates ? 
            (Array.isArray(place.coordinates) ? place.coordinates[1] : place.latitude) : 
            place.latitude;
